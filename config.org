...
- [[#vertico][Vertico]]
  - [[#vertico-1][vertico]]
    - [[#prefix-current-candidate-with-arrow][Prefix current candidate with arrow]]
  - [[#replace-vertico-prescient-with-orderless][replace vertico-prescient with orderless]]
...
** TODO replace vertico-prescient with orderless
*** vertico-prescient
#+begin_src emacs-lisp
